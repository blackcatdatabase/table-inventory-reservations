...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at', 'version' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'order_id', 'book_id', 'quantity', 'version' ]; }
