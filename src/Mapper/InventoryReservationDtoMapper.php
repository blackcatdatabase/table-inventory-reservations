...
final class InventoryReservationDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'order_id' => 'orderId', 'book_id' => 'bookId', 'reserved_until' => 'reservedUntil', 'created_at' => 'createdAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'order_id', 'book_id', 'quantity' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'order_id' ];
    ...
    public static function fromRow(array $row): InventoryReservationDto {
        ...
        return new InventoryReservationDto(...$vals);
    }
