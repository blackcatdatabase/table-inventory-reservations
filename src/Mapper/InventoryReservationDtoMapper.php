...
namespace BlackCat\Database\Packages\InventoryReservations\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO InventoryReservationDto:
...
final class InventoryReservationDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'order_id', 'book_id', 'quantity', 'version' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'reserved_until', 'created_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): InventoryReservationDto
    {
        /** @var InventoryReservationDto */
    ...
    public static function fromRowOrNull(?array $row): ?InventoryReservationDto
    {
     ...
     *
     * @param InventoryReservationDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(InventoryReservationDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(InventoryReservationDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(InventoryReservationDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,InventoryReservationDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,InventoryReservationDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(InventoryReservationDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,InventoryReservationDto>
     */
