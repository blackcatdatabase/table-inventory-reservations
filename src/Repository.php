...
use BlackCat\Database\Packages\InventoryReservations\Repository\InventoryReservationRepository as GeneratedRepository;
...
{
  private InventoryReservationRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof InventoryReservationRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected InventoryReservationRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\InventoryReservations\Dto\InventoryReservationDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\InventoryReservations\Dto\InventoryReservationDto|null { return $this->repo->getById($id, $asDto); }
