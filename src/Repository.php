...
final class Repository
{
    ...
    {
        $this->repo = new InventoryReservationRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\InventoryReservations\Dto\InventoryReservationDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\InventoryReservations\Dto\InventoryReservationDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\InventoryReservations\Dto\InventoryReservationDto|null
    {
