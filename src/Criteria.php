...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at' ], true);
            $parts = [];
