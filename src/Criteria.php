...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'tenant_id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at', 'version' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'tenants' => 'j0', 'books' => 'j1', 'orders' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\InventoryReservations\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\InventoryReservations\Definitions::softDeleteColumn();
