 ...
 * - whitelist filtrů: [ 'id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at', 'version' ]
 * - whitelist LIKE:   [ 'status' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at', 'version' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'order_id', 'book_id', 'quantity', 'reserved_until', 'status', 'created_at', 'version' ], true);
            $parts = [];
