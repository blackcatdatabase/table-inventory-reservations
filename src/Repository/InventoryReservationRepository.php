...
use BlackCat\Database\Packages\InventoryReservations\Repository\InventoryReservationRepositoryInterface;
...
class InventoryReservationRepository implements InventoryReservationRepositoryInterface, RepoContract, KeysetRepoContract
{
use OrderByTools, PkTools, RepositoryHelpers;
    ...
    public function upsertMany(array $rows): int {
        ...
        if ($helperKeys && class_exists(\BlackCat\Database\Support\BulkUpsertHelper::class)) {
          $bulk = new \BlackCat\Database\Support\BulkUpsertHelper($this->db, \BlackCat\Database\Packages\InventoryReservations\Definitions::class);
