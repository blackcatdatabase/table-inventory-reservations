...
namespace BlackCat\Database\Packages\InventoryReservations\Joins;
 ...
 */
final class InventoryReservationsJoins {
    ...
    /**
     * FK: inventory_reservations -> tenants
    ...
    /**
     * FK: inventory_reservations -> books
    ...
    /**
     * FK: inventory_reservations -> orders
