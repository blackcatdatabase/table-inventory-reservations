...
| Pkg folder | [packages/inventory-reservations](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/inventory-reservations) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package inventory-reservations -Apply
