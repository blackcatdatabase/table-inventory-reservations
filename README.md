...
- Pkg folder: [packages\inventory-reservations](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\inventory-reservations)
...
graph LR
  ...
  inventory_reservations["inventory_reservations"]:::center
  inventory_reservations -->|FK| books["books"]:::link
  inventory_reservations -->|FK| orders["orders"]:::accent
  inventory_reservations -->|FK| tenants["tenants"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package inventory-reservations -Apply
